...
public class ControllerTwo {
    ...
    public ControllerTwo(LDClient ldClient) {
    ...
    public String message(@RequestParam String userId) {
        ...
        return "Welcome to application TWO - <br>flag evaluated to - " + flagValue + ". <br>" + "for user : " + userId + " <br>Context details are - " + context;
    }
}
